 ...
 * hd44780_hw.h
 *
 * Created: 17.08.2022 18:53:24
 *  Author: domis
 */ 


#ifndef HD44780_HW_H_
#define HD44780_HW_H_
...
/*
*	Stworzone na podstawie kodu od Joerga Wunscha, zmienione w taki sposob, zeby dzialalo pod buforem
*/
...
/*
*	================================
*	Moja dodana funkcja do obslugi bufora - nie ma w niej sygnalu enable
*	================================
*/

void hd44780_outnibble_wo_pulse(uint8_t n, uint8_t rs);
